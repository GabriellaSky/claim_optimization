...
class Encoder:
    ...
    def __init__(self, encoder, bpe_merges, errors='replace'):
        ...
        self.pat = self.re.compile(r"""'s|'t|'re|'ve|'m|<A0>|<EOT>| <EOT>|<V>|<A1>|<LINK>| <LINK>|<A2>| <A0>|<P>| <P>|<A1>| <A1>| <A2>| <V>| </s>|</s>|'ll|'d| ?\p{L}+| ?\p{N}+| ?[^\s\p{L}\p{N}]+|\s+(?!\S)|\s+""")

    def bpe(self, token):
        if token in ['<A0>','<A1>','<A2>','<V>','<LINK>','</s>','<P>','<EOT>','\u0120<A0>','\u0120<A1>','\u0120<A2>','\u0120<V>','\u0120</s>','\u0120<P>','\u0120<EOT>','\u0120<LINK>']:
